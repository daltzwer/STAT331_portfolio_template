...
The dim() function tells us that there are 30, 463 rows and 15 columns in this data set.
...
Double: record_id, month, day, year, hindfoot_length, weight
...
ggplot(data = surveys,
  ...
  #properly labeling x and y axis 
...
Reflection: When I initially attempted to do the YAML, my understanding of its formatting was a little off. I put my code-tools: true under formatting and messages: false was nowhere to be found. I now know how each of these works and where to put them. Question 2 and 3 was something I completely missed which I felt like I could have avoided. I understand the importance of explaining the output of the code I wrote and will be doing so going forward. During this process, I was thinking that since it was clearly indicated in my output already, typing it up would be redundant but now I am taking the approach that I am presenting this data to someone who does not understand code. I also now know the difference between position = jitter and geom_jitter(). Geom_jitter allows me to to control the jittering of the points. Before this explanation, I thought they were pretty much interchangeable. I also realized that the order of which I code in my plots matter as one will be over the other. Since I wanted to see my boxplots a little better, I should have put it AFTER geom_jitter(). Finally, I made the assumption that "species" was specific enough but when I look back at my code, I may not know what species I am talking about so it is best to be as specific as possible going forward.
